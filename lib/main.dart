...
// import 'package:flutter_practice/camera_page.dart';
// import 'package:flutter_practice/camera_widget.dart';
...
//   Uint8List image= Uint8List.fromList([72, 101, 108, 108, 111]);
//   void onImageChange(Uint8List image){
//     setState(() {
//       this.image = image;
//     });
//   }
...
//             await Navigator.push(context, MaterialPageRoute(builder: (context) => CameraWidget(onImageChange:  onImageChange)));
//           }
//           else{
//             await Navigator.push(context, MaterialPageRoute(builder: (context) => CameraPage(onImageChange:  onImageChange)));
//           }
